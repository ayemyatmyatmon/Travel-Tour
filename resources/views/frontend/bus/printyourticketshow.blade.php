                        ...
                        <div class="card">
                            ...
                            <div class="card-body ">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        <tr >
                                            <td>{{$booking->schedule->bus_operator ? $booking->schedule->bus_operator->name:''}}</td>
                                            <td>{{$booking->schedule->from_city ? $booking->schedule->from_city->name:''}}</td>
                                            <td>{{$booking->schedule->to_city ? $booking->schedule->to_city->name:''}}</td>
                                            <td>{{$booking->day}}</td>
                                            <td>{{$booking->schedule->departure_time ? 'Carbon\Carbon'::parse($booking->schedule->departure_time)->format('H:m:s A'):''}}</td>
                                        </tr>
                                    </tbody>
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <span>{{number_format($booking->price)}} MMK</span>
                                    </div>
                                </div>
                            </div>
                        </div>
